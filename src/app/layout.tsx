...
export const metadata: Metadata = {
  title: "Пузата Хата - Автентична українська кухня",
  description: "Ресторан традиційної української кухні в серці міста. Борщ, вареники, котлета по-київськи та інші улюблені страви. Забронюйте столик!",
  keywords: "український ресторан, борщ, вареники, котлета по-київськи, традиційна кухня, Пузата Хата",
  openGraph: {
    title: "Пузата Хата - Автентична українська кухня",
    description: "Відкрийте для себе смаки традиційної України в найзатишніших умовах",
    siteName: "Пузата Хата",
    type: "website",
    images: [{
      url: "https://pixabay.com/get/g57179666273030b2cd1ffd995cca1a0cbc7bcefe7fd349e7c4c67976c51acef0e2eedbadb52a1916b5433888b49785b7f2c45c89875c19204aa341fe7efcd0c1_1280.jpg",
      alt: "Ресторан Пузата Хата"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Пузата Хата - Автентична українська кухня",
    description: "Відкрийте для себе смаки традиційної України",
    images: ["https://pixabay.com/get/g57179666273030b2cd1ffd995cca1a0cbc7bcefe7fd349e7c4c67976c51acef0e2eedbadb52a1916b5433888b49785b7f2c45c89875c19204aa341fe7efcd0c1_1280.jpg"]
  },
  robots: {
    index: true,
    follow: true
